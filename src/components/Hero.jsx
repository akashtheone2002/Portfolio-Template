...
const Hero = () => {
  return (
    <>
      ...
      <div className="absolute top-0 left-0 z-0 h-[50vh] w-screen">
        <img
          src={worldmap}
          alt="world map"
      ...
      <section
        ...
        <div
          ...
          <div className="flex flex-col justify-center items-center mt-2 ml-0">
            <div className="w-5 h-5 rounded-full bg-[#0a0a0a] sm:hidden" />
            <div className="w-1 sm:h-70 h-40 bw-gradient sm:hidden" />
          </div>
          <div>
            <h1
        ...
        <div>
          <img
            ...
            lg:ml-[75vw] md:ml-[60vw] xmd:ml-[60vw] 2xl:ml-[50vw]
